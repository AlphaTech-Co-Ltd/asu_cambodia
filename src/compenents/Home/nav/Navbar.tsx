    ...
    <div
      ...
      <div
        ...
        <div className={"flex items-center space-x-2"}>
          <div
            className={
              "w-10 h-10 bg-white rounded-full flex items-center justify-center flex-col"
            }>
            <Link href="/">
              <Image
          ...
          <h1
            className={
              "text-xl font-bold text-white hidden sm:block md:text-2xl"
            }>
            ASU Cambodia
          </h1>
        </div>
          ...
          {NavLinks.map((link) => (
            <Link
              ...
              <span className="flex items-center space-x-1 hover:text-yellow-500 duration-300">
                {link.icon}
                <span className={"hover:text-yellow-500 duration-300"}>
                  {link.label}
                </span>
              </span>
